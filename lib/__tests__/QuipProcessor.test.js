...
describe('methods tests', () => {
    ...
    describe('_processDocumentThread', () => {
        ...
        test('run with document template and embedded css', async () => {
            ...
            await quipProcessor._processDocumentThread(thread, '/aaa/');
            expect(quipProcessor._processFile).toHaveBeenCalledTimes(2);
            expect(quipProcessor._processFile).toHaveBeenCalledWith('TEMPLATED DOCUMENT_1', expect.anything(), '/aaa/');
            expect(quipProcessor._processFile).toHaveBeenCalledWith('TEMPLATED DOCUMENT', expect.anything(), '/aaa/', undefined);
        ...
        test('run with embedded images', async () => {
            ...
            expect(quipProcessor._processFile).toHaveBeenCalledTimes(2);
            expect(quipProcessor._processFile).toHaveBeenCalledWith(`${thread.html}_1`, expect.anything(), '/aaa/');
            expect(quipProcessor._processFile).toHaveBeenCalledWith(thread.html, expect.anything(), '/aaa/', true);
        });
