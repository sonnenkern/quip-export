    ...
    async processDocuments(threadHtml, documents, path) {
        ...
        for(let index in documents) {
            ...
            try {
                ...
                //blob.size
                this.saveCallback(blob, `${document.blobId}.${Mime.getExtension(blob.type)}`, "DOCUMENT", path);
            }
            catch (e) {}
        }
